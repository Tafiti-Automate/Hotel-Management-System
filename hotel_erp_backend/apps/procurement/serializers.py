...
class PurchaseRequisitionSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        if (
            ...
            and procurement_source != "store_shortage"
        ):
            if not employee:
        ...
        if procurement_source == "store_shortage" and self.instance is None:
            raise serializers.ValidationError(
                {"procurement_source": "Store-shortage Purchase Requisitions are generated by Stores."}
            )
